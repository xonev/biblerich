$ ->
  Flashcards.init '/bible-highlights/review/exodus/chapter-20.html', [
    ...
    { img: 'commandments/5.png', text: 'Honor father and mother' }
    { img: 'commandments/6.png', text: 'Not kill' }
    { img: 'commandments/7.png', text: 'Not commit adultery' }
    { img: 'commandments/8.png', text: 'Not steal' }
    { img: 'commandments/9.png', text: 'Not lie' }
    { img: 'commandments/10.png', text: 'Not covet' }
  ]
