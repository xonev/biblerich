...
(function() {
  var click, clickFunc, exampleView, exampleViews, highlight, highlightFunc, navigate, navigateFunc, removeHighlight, removeHighlightFunc, viewsForIndex, viewsForQuizYourself, viewsForTeachYourself;
  ...
  viewsForQuizYourself = function() {
    ...
    views.push(exampleView("You can navigate through the cards with the arrow buttons.", highlightFunc('.prev, .next'), removeHighlightFunc('.prev, .next')));
    ...
    views.push(exampleView("Now you know the basics! Learn the Days of Creation,    or, if you'd really like to, feel free to explore the rest of the site!"));
    return views;
  };
